  ...
  const { site, siteLogo, defaultFb } = useStaticQuery(
    graphql`
      query {
        ...
        siteLogo: file(relativePath: { eq: "resolve-logo.png" }) {
          publicURL
        }
  ...
  return (
    <React.Fragment>
      ...
      <SchemaOrg
        ...
        canonicalUrl="https://www.resolvelegalgroup.com/"
        author=""
        organization="Resolve Legal Group"
        defaultTitle="Resolve Legal Group"
      />
    </React.Fragment>
  )
}
